...
class MBLForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'airline_address':forms.Textarea(attrs={'class':'form-control','rows':4}),
            
            'bl_type':forms.Select(attrs={'class':'form-control'}),
            'notify_party':forms.Select(attrs={'class':'form-control'}),
            'notify_party_address':forms.Textarea(attrs={'class':'form-control','rows':4}),
            'agent_iata_code':forms.TextInput(attrs={'class':'form-control'}),
            'account_no':forms.TextInput(attrs={'class':'form-control'}),
            'declared_value_customs':forms.TextInput(attrs={'class':'form-control'}),
            'origin_to':forms.TextInput(attrs={'class':'form-control'}),
            'valuation_charge':forms.TextInput(attrs={'class':'form-control'}),
            'other_charge_due_agent':forms.TextInput(attrs={'class':'form-control'}),
            'other_charge_due_carrier':forms.TextInput(attrs={'class':'form-control'}),
            ...
            'signature_company':forms.TextInput(attrs={'class':'form-control form-control-sm','value':'JAGYAT GLOBAL TRANSPORT AND LOGISTICS PVT. LTD.'}),
            'signature_for':forms.TextInput(attrs={'class':'form-control form-control-sm','value':'Signature of Shipper of his Agent'}),
